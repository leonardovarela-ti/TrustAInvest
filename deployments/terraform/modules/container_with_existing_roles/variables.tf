...
variable "ecs_task_execution_role_arn" {
  description = "The ARN of an existing ECS task execution role to use (if not provided, a new role will be created)"
  type        = string
  default     = null
}

variable "ecs_task_role_arn" {
  description = "The ARN of an existing ECS task role to use (if not provided, a new role will be created)"
  type        = string
  default     = null
}
